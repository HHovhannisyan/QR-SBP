 ...
 */
public abstract class Hilt_SettingDisplayFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SettingDisplayFragment() {
    super();
  }

  Hilt_SettingDisplayFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SettingDisplayFragment_GeneratedInjector) this.generatedComponent()).injectSettingDisplayFragment(UnsafeCasts.<SettingDisplayFragment>unsafeCast(this));
    }
  }
