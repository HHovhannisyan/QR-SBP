 ...
 */
public abstract class Hilt_PaymentInfoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PaymentInfoFragment() {
    super();
  }

  Hilt_PaymentInfoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PaymentInfoFragment_GeneratedInjector) this.generatedComponent()).injectPaymentInfoFragment(UnsafeCasts.<PaymentInfoFragment>unsafeCast(this));
    }
  }
