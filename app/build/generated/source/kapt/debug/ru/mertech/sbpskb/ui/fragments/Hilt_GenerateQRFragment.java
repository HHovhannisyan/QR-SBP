 ...
 */
public abstract class Hilt_GenerateQRFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_GenerateQRFragment() {
    super();
  }

  Hilt_GenerateQRFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GenerateQRFragment_GeneratedInjector) this.generatedComponent()).injectGenerateQRFragment(UnsafeCasts.<GenerateQRFragment>unsafeCast(this));
    }
  }
