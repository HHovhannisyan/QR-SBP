 ...
 */
abstract class Hilt_StatusFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_StatusFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StatusFragment_GeneratedInjector) this.generatedComponent()).injectStatusFragment(UnsafeCasts.<StatusFragment>unsafeCast(this));
    }
  }
