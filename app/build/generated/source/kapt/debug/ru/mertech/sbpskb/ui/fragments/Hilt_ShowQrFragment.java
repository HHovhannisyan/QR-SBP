 ...
 */
public abstract class Hilt_ShowQrFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ShowQrFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ShowQrFragment_GeneratedInjector) this.generatedComponent()).injectShowQrFragment(UnsafeCasts.<ShowQrFragment>unsafeCast(this));
    }
  }
