...
public final class ListviewItemBinding implements ViewBinding {
  ...
  private ListviewItemBinding(@NonNull LinearLayout rootView, @NonNull ImageView imageView,
  ...
  public static ListviewItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListviewItemBinding((LinearLayout) rootView, imageView, textView);
    }
