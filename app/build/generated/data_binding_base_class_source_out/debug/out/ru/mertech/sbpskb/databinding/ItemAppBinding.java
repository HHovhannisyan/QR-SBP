...
public final class ItemAppBinding implements ViewBinding {
  ...
  private ItemAppBinding(@NonNull RelativeLayout rootView, @NonNull ImageView imgLogo,
      @NonNull CardView logo, @NonNull TextView tvName) {
  ...
  public static ItemAppBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemAppBinding((RelativeLayout) rootView, imgLogo, logo, tvName);
    }
